...
#ifndef PING_NODELET_PING_MESSAGE_PING1D_H
#define PING_NODELET_PING_MESSAGE_PING1D_H
...
{
public:
    explicit ping1d_ping_interval(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_processor_temperature(const ping_message& msg) : ping_message { msg } {}
    ...
    void set_processor_temperature(const uint16_t processor_temperature)
    {
        (uint16_t&)msgData[headerLength + 0] = processor_temperature;
    }
};
...
{
public:
    explicit ping1d_speed_of_sound(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_gain_setting(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_range(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_transmit_duration(const ping_message& msg) : ping_message { msg } {}
    ...
    {
        (uint16_t&)msgData[headerLength + 0] = transmit_duration;
    }
};
...
{
public:
    explicit ping1d_ping_enable(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_pcb_temperature(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_firmware_version(const ping_message& msg) : ping_message { msg } {}
    ...
    void set_firmware_version_major(const uint16_t firmware_version_major)
    {
        (uint16_t&)msgData[headerLength + 2] = firmware_version_major;
    }
    uint16_t firmware_version_minor() const { return (uint16_t&)msgData[headerLength + 4]; }
    void set_firmware_version_minor(const uint16_t firmware_version_minor)
    {
        (uint16_t&)msgData[headerLength + 4] = firmware_version_minor;
    }
};
...
{
public:
    explicit ping1d_distance_simple(const ping_message& msg) : ping_message { msg } {}
    ...
    ping1d_distance_simple() : ping_message { static_cast<uint16_t>(15) }
    {
        ...
        (uint16_t&)msgData[4] = Ping1dId::DISTANCE_SIMPLE;  // ID
        msgData[6] = 0;
        msgData[7] = 0;
    }
...
{
public:
    explicit ping1d_profile(const ping_message& msg) : ping_message { msg } {}
    ...
    void set_transmit_duration(const uint16_t transmit_duration)
    {
        (uint16_t&)msgData[headerLength + 6] = transmit_duration;
    }
    ...
    void set_profile_data_length(const uint16_t profile_data_length)
    {
        (uint16_t&)msgData[headerLength + 24] = profile_data_length;
    }
...
{
public:
    explicit ping1d_mode_auto(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_distance(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_device_id(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_voltage_5(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_general_info(const ping_message& msg) : ping_message { msg } {}
    ...
    void set_firmware_version_major(const uint16_t firmware_version_major)
    {
        (uint16_t&)msgData[headerLength + 0] = firmware_version_major;
    }
    uint16_t firmware_version_minor() const { return (uint16_t&)msgData[headerLength + 2]; }
    void set_firmware_version_minor(const uint16_t firmware_version_minor)
    {
        (uint16_t&)msgData[headerLength + 2] = firmware_version_minor;
    }
...
{
public:
    explicit ping1d_continuous_stop(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_continuous_start(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_goto_bootloader(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_set_device_id(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_set_ping_enable(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_set_speed_of_sound(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_set_mode_auto(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_set_gain_setting(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_set_ping_interval(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit ping1d_set_range(const ping_message& msg) : ping_message { msg } {}
...
#endif  // PING_NODELET_PING_MESSAGE_PING1D_H
