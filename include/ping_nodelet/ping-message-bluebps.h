...
#ifndef PING_NODELET_PING_MESSAGE_BLUEBPS_H
#define PING_NODELET_PING_MESSAGE_BLUEBPS_H
...
{
public:
    explicit bluebps_temperature_max(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_temperature_timeout(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_cell_timeout(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_current_max(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_events(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_cell_voltage_min(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_state(const ping_message& msg) : ping_message { msg } {}
    ...
    void set_battery_temperature(const uint16_t battery_temperature)
    {
        (uint16_t&)msgData[headerLength + 4] = battery_temperature;
    }
    ...
    void set_cell_voltages_length(const uint8_t cell_voltages_length)
    {
        (uint8_t&)msgData[headerLength + 9] = cell_voltages_length;
    }
    uint16_t* cell_voltages() const { return reinterpret_cast<uint16_t*>(msgData+headerLength+10); }
    void set_cell_voltages_at(const uint16_t i, const uint16_t data)
    {
        (uint16_t&)msgData[headerLength + 10 + i] = data;
    }
};
...
{
public:
    explicit bluebps_current_timeout(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_reboot(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_erase_flash(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_reset_defaults(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_set_current_max(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_set_temperature_max(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_set_lpf_sample_frequency(const ping_message& msg) : ping_message { msg } {}
    ...
    void set_sample_frequency(const uint32_t sample_frequency)
    {
        (uint32_t&)msgData[headerLength + 0] = sample_frequency;
    }
};
...
{
public:
    explicit bluebps_set_temperature_timeout(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_set_current_timeout(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_set_cell_voltage_timeout(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_set_stream_rate(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_set_cell_voltage_minimum(const ping_message& msg) : ping_message { msg } {}
...
{
public:
    explicit bluebps_set_lpf_setting(const ping_message& msg) : ping_message { msg } {}
...
#endif  // PING_NODELET_PING_MESSAGE_BLUEBPS_H
